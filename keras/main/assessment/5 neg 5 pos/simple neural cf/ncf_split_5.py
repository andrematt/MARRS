...
df_train=pd.read_csv(path + "/fold_5_train.csv", encoding="latin-1", sep=",", index_col=False)
df_train.head()

df_test=pd.read_csv(path + "/fold_5_test.csv", encoding="latin-1", index_col=False)
df_test.head()
...
history_df.to_csv('simple_ncf_split_5.csv', index=False)
