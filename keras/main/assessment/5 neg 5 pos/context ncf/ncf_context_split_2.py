...
df_train=pd.read_csv(path + "your_path/data/fold_2_train.csv", encoding="latin-1", sep=",", index_col=False)
df_train.head()

df_test=pd.read_csv(path + "your_path/data/fold_2_test.csv", encoding="latin-1", index_col=False)
df_test.head()
