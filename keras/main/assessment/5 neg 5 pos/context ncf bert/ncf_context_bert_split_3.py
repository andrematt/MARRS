...
df_test=pd.read_csv(path + "/fold_3_test.csv", encoding="latin-1", sep=",", index_col=False)
df_test.head()
...
merged_vector = tf.keras.layers.concatenate([dot, fc3, bert_net]) 
...
history_df.to_csv('ncf_context_bert_split_3.csv', index=False)
