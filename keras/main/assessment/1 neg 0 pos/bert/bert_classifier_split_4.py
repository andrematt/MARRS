...
train=pd.read_csv(path + "/fold_4_train.csv", encoding="latin-1", sep=",", index_col=False)
train.head()

test=pd.read_csv(path + "/fold_4_test.csv", encoding="latin-1", sep=",", index_col=False)
test.head()
...
history_df.to_csv('bert_split_4.csv', index=False)
