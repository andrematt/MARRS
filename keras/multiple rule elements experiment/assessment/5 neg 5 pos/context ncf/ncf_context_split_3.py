...
df_train=pd.read_csv(path + "your_path/data/fold_3_train.csv", encoding="latin-1", sep=",", index_col=False)
df_train.head()

df_test=pd.read_csv(path + "your_path/data/fold_3_test.csv", encoding="latin-1", index_col=False)
df_test.head()
...
history_df.to_csv('ncf_context_split_3.csv', index=False)
