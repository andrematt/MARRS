...
Contains the datasets, models structure files, and training outcomes for the paper "Personalised Recommendations for Daily Automations in a Mobile Augmented Reality Application" submitted to the IEEE Access journal.
