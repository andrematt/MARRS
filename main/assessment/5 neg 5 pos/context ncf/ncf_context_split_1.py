...
path = "C:/Users/andre/programmazione/python/new_assessment/main/data/K-FOLD_DATA_WITH_SINGLES/5 neg 5 pos"

df_train=pd.read_csv(path + "your_path/data/fold_1_train.csv", encoding="latin-1", sep=",", index_col=False)
df_train.head()

df_test=pd.read_csv(path + "your_path/data/fold_1_test.csv", encoding="latin-1", index_col=False)
df_test.head()
...
history_df.to_csv('ncf_context_split_1.csv', index=False)
