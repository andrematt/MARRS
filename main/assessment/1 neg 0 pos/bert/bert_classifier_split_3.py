...
train=pd.read_csv(path + "/fold_3_train.csv", encoding="latin-1", sep=",", index_col=False)
train.head()

test=pd.read_csv(path + "/fold_3_test.csv", encoding="latin-1", sep=",", index_col=False)
test.head()
...
history_df.to_csv('bert_split_3.csv', index=False)
